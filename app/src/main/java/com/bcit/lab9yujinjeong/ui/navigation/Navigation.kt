package com.bcit.lab9yujinjeong.ui.navigation
...
import com.bcit.lab9yujinjeong.ui.screens.AddAlarmScreen
import com.bcit.lab9yujinjeong.ui.screens.CardGameScreen
import com.bcit.lab9yujinjeong.ui.screens.HomeScreen
...
sealed class Screen(val route: String) {
    ...
    /**
     * Helper function for creating route string in easy way. (These functions requires alarmID in
     * the route and making easier to insert ID)
     */
    fun createRoute(alarmId: Int): String {
        return when (this) {
            is EditAlarm -> "edit_alarm/$alarmId"
            is CardGame -> "card_game/$alarmId"
            else -> route
        }
    }
}
    ...
    NavHost(
        ...
        composable(
            ...
            CardGameScreen(
                ...
                onGameComplete = { navController.popBackStack(Screen.Home.route, inclusive = false)}
            )
        }
    }
}